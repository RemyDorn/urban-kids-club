...
export const Validators = {
  ...
  activityHasCapacity(activityId: ID): ValidationResult & { waitlist?: boolean } {
    ...
    // Add-Up-Slots sind Provider-Buffer, NICHT Kunden-Buchungsfläche (siehe project_ukc_addup_concept.md).
    // Validator blockt reguläre Buchungen bei reiner capacity → Warteliste-Signal.
